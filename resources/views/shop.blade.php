            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="details.html"><img loading="lazy" src="{{asset('uploads/produits/' . $produit->image)}}" width="330" height="400" alt="{{ $produit->name }}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(',', $produit->images) as $gimg)
                      <a href="details.html"><img loading="lazy" src="{{asset('uploads/produits/' . $gimg)}}" width="330" height="400" alt="{{ $produit->name }}" class="pc__img"></a>
                          @endforeach
                    </div>
                  </div>
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">{{ $produit->category->name ?? 'Sans catégorie' }}</p>
                <h6 class="pc__title"><a href="details.html">{{ $produit->name }}</a></h6>
                <div class="product-card__price d-flex">
                  <span class="money price">
                    @if($produit->sale_price)
                    <s>${{ $produit->regular_price }}</s>${{ $produit->sale_price }}
                    @else${{ $produit->regular_price }}
                    @endif
                </div>
